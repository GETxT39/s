  ...
  return (
    <>
      <header className="ml-20">
        <div className="mt-0">
          <h1 className="title">XXXXXX</h1>
          <h3 className="">12A2</h3>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero
            nostrum quis, odio veniam ita
          </p>
        </div>
      </header>
      <div className="fui-sidbar-navigiation">
          ...
          <header>
            <div className="image-text">
              ...
              <div className="text logo-text">
                <span className="name">Fast UI</span>
                <span className="profession">Sidebar menu</span>
              </div>
            </div>
                  ...
                  <a href="#">
                    <span className="icon">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M21 11C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H19C18.4477 13 18 12.5523 18 12C18 11.4477 18.4477 11 19 11H21Z"
                          fill="currentColor"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M17.6569 4.92903C18.0474 4.53851 18.6806 4.53851 19.0711 4.92903C19.4616 5.31955 19.4616 5.95272 19.0711 6.34324L17.6569 7.75746C17.2664 8.14798 16.6332 8.14798 16.2427 7.75746C15.8522 7.36693 15.8522 6.73377 16.2427 6.34324L17.6569 4.92903Z"
                          fill="currentColor"
                        />
                        <path
                          d="M7.7574 16.2428C7.36688 15.8522 6.73371 15.8522 6.34319 16.2428L4.92897 17.657C4.53845 18.0475 4.53845 18.6807 4.92897 19.0712C5.3195 19.4617 5.95266 19.4617 6.34319 19.0712L7.7574 17.657C8.14792 17.2664 8.14792 16.6333 7.7574 16.2428Z"
                          fill="currentColor"
                        />
                        <path
                          d="M19.0711 17.6569C19.4616 18.0474 19.4616 18.6806 19.0711 19.0711C18.6806 19.4616 18.0474 19.4616 17.6569 19.0711L16.2427 17.6569C15.8521 17.2664 15.8521 16.6332 16.2427 16.2427C16.6332 15.8522 17.2664 15.8522 17.6569 16.2427L19.0711 17.6569Z"
                          fill="currentColor"
                        />
                        <path
                          d="M7.75737 7.7574C8.14789 7.36688 8.14789 6.73371 7.75737 6.34319L6.34316 4.92897C5.95263 4.53845 5.31947 4.53845 4.92894 4.92897C4.53842 5.3195 4.53842 5.95266 4.92894 6.34319L6.34316 7.7574C6.73368 8.14792 7.36685 8.14792 7.75737 7.7574Z"
                          fill="currentColor"
                        />
                        <path
                          fillRule="evenodd"
      ...
      <div className="ml-20">
        <section className="ml-5">
          <h3 className="capitalize">
            Natural beauty. which is grateful in Bangladesh.
          </h3>
          <img
            className="w-40 h-40"
            src="https://images.pexels.com/photos/257840/pexels-photo-257840.jpeg?cs=srgb&dl=agriculture-apple-blur-257840.jpg&fm=jpg"
            alt
          />
          <p className="date">12th December, 2018</p>
          <p>
            One morning, when Gregor Samsa woke from troubled dreams, he found
            himse arches into stiff sections.
          </p>
        </section>
      </div>
